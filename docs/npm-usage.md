...
| `arch` | `string \| undefined` | No | Project mode: target architecture (x64, arm64, or x86). Ignored in folder mode. Rejected for a .cs file-based app, which declares its own architecture with '#:property RuntimeIdentifier=win-x64'. Default: the current process architecture. |
