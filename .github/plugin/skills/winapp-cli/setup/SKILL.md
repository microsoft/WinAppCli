...
> **`--debug-output` caveat:** Captures `OutputDebugString` but attaches winapp as the debugger â€” you cannot also attach VS Code or WinDbg. Use `--no-launch` if you need your own debugger.
