...
| Copilot plugin | `.github/plugin/` | Skills + `agents/winapp.agent.md` |

## Autogenerated — flag staleness, never edit

- `docs/cli-schema.json` and `.github/plugin/skills/winapp-cli/*/SKILL.md` are
...
- `.claude/` mirrors `.github/plugin/` via `scripts/sync-claude-plugin.ps1`.
...
- `.github/plugin/agents/winapp.agent.md` — it has both a decision tree **and** a
