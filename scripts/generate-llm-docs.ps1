...
$SkillCommandMap = @{
    ...
    "ui-automation"   = @("ui status", "ui inspect", "ui search", "ui get-property", "ui get-text", "ui screenshot", "ui invoke", "ui click", "ui set-value", "ui focus", "ui scroll-into-view", "ui scroll", "ui wait-for", "ui list-windows", "ui get-focused")
}
