...
# Generate each skill
$SkillNames = @("setup", "package", "identity", "signing", "manifest", "troubleshoot", "frameworks", "ui-automation", "upgrade")
$SkillDescriptions = @{
    ...
    "upgrade"         = "Update the winapp CLI to the latest version. Use when the user wants to upgrade winapp, check for updates, or troubleshoot version-related issues."
}
