...
$SkillCommandMap = @{
    ...
    "controls"        = @("controls search", "controls get", "controls list", "controls refresh")
}
...
# Generate each skill
$SkillNames = @("setup", "package", "identity", "signing", "manifest", "troubleshoot", "frameworks", "ui-automation", "controls")
$SkillDescriptions = @{
