...
> Code calling these APIs directly drives the desktop immediately and is outside that guarantee — if
> you run it alongside `winapp ui`, or alongside another copy of itself, you are responsible for
> serializing the two.
