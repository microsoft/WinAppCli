...
internal class WinAppRootCommand : RootCommand
{
    ...
    public WinAppRootCommand(
        ...
        NewCommand newCommand) : base("CLI for generating and managing appxmanifest.xml, image assets, test certificates, Windows (App) SDK projections, package identity, and packaging. For use with any app framework targeting Windows")
    {
