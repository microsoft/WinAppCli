...
internal class WinAppRootCommand : RootCommand, IShortDescription
{
        ...
        SandboxCommand sandboxCommand) : base("CLI for Windows app development, including package identity, packaging, managing Package.appxmanifest, test certificates, Windows (App) SDK projections, and more. For use with any app framework targeting Windows")
    {
        ...
        helpOption.Action = new CustomHelpAction(this, ansiConsole,
            ...
            ("Development Tools", [typeof(CreateDebugIdentityCommand), typeof(MSStoreCommand), typeof(ToolCommand), typeof(GetWinappPathCommand), typeof(RunCommand), typeof(UnregisterCommand), typeof(SandboxCommand)]),
