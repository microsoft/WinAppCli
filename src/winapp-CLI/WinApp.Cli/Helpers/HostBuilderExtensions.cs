...
internal static class StoreHostBuilderExtensions
{
    public static IServiceCollection ConfigureServices(this IServiceCollection services)
    {
        return services
            ...
            .AddSingleton<IWindowsAppRuntimeDeploymentService, WindowsAppRuntimeDeploymentService>()
    ...
    public static IServiceCollection ConfigureCommands(this IServiceCollection serviceCollection)
    {
        return serviceCollection
                ...
                .ConfigureCommand<RuntimeCommand>()
                .UseCommandHandler<RuntimePrepareCommand, RuntimePrepareCommand.Handler>()
