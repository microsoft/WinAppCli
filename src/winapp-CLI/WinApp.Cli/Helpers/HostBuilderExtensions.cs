...
internal static class StoreHostBuilderExtensions
{
    public static IServiceCollection ConfigureServices(this IServiceCollection services)
    {
        return services
            ...
            .AddSingleton<IDynWinrtCodegenService, DynWinrtCodegenService>()
            .AddSingleton<IJsBindingsWorkspaceService, JsBindingsWorkspaceService>()
            .AddSingleton<INpmWrapperVersionProvider, NpmWrapperVersionProvider>()
            .AddSingleton<IPackageManagerDetector, PackageManagerDetector>()
            .AddSingleton<IUserPackageJsonService, UserPackageJsonService>()
