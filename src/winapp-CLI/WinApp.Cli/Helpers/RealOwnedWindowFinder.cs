...
internal sealed class RealOwnedWindowFinder : IOwnedWindowFinder
{
    ...
    /// live desktop.
    /// </remarks>
    internal static Func<Windows.Win32.Foundation.HWND, Windows.Win32.Foundation.HWND> s_findNextTopLevelWindow =
        NativeFindNextTopLevelWindow;

    internal static Windows.Win32.Foundation.HWND NativeFindNextTopLevelWindow(Windows.Win32.Foundation.HWND after)
        => Windows.Win32.PInvoke.FindWindowEx(
            Windows.Win32.Foundation.HWND.Null, after, null, (string?)null);

    /// <remarks>
    /// Native adapter seam for issue #630: the default body queries live HWND visibility. Tests inject
    /// deterministic visibility.
    /// </remarks>
    internal static Func<Windows.Win32.Foundation.HWND, bool> s_isWindowVisible =
        NativeIsWindowVisible;

    internal static bool NativeIsWindowVisible(Windows.Win32.Foundation.HWND hwnd)
        => Windows.Win32.PInvoke.IsWindowVisible(hwnd);

    /// <remarks>
    /// Native adapter seam for issue #630: the default body queries live HWND ownership. Tests inject
    /// deterministic owners.
    /// </remarks>
    internal static Func<Windows.Win32.Foundation.HWND, Windows.Win32.Foundation.HWND> s_getWindowOwner =
        NativeGetWindowOwner;

    internal static Windows.Win32.Foundation.HWND NativeGetWindowOwner(Windows.Win32.Foundation.HWND hwnd)
        => Windows.Win32.PInvoke.GetWindow(
            hwnd, Windows.Win32.UI.WindowsAndMessaging.GET_WINDOW_CMD.GW_OWNER);

    /// <remarks>
    /// Native adapter seam for issue #630: the default body reads the owning PID from a live HWND.
    /// Tests inject deterministic PIDs.
    /// </remarks>
    internal static Func<Windows.Win32.Foundation.HWND, int> s_getWindowProcessId = NativeGetWindowProcessId;

    internal static int NativeGetWindowProcessId(Windows.Win32.Foundation.HWND hwnd)
    {
        unsafe
        {
            uint pid = 0;
    ...
    /// </remarks>
    internal static Func<Windows.Win32.Foundation.HWND, string> s_getWindowText = NativeGetWindowText;

    internal static string NativeGetWindowText(Windows.Win32.Foundation.HWND hwnd)
    {
        unsafe
        {
