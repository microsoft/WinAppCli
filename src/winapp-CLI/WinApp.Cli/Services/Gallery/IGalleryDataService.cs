...
/// exposes a configured <see cref="SearchEngine"/> for the gallery commands.
///
...
/// </summary>
internal interface IGalleryDataService
{
    /// <summary>
    ...
    /// <summary>
    /// Deletes both the Gallery and Toolkit cache directories so the next <see cref="GetEngine"/>
