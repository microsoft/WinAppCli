...
internal interface IDebugOutputService
{
    ...
    /// <param name="captureDebug">Whether to output OutputDebugString messages.</param>
    ...
    Task RunDebugEventLoopAsync(uint processId, TextWriter output, bool captureDebug = true, bool captureExceptions = true, CancellationToken cancellationToken = default);
}
