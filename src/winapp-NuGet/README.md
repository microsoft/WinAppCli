# Microsoft.WindowsAppSDK.RunSupport

Enables `dotnet run` for packaged WinUI and Windows App SDK applications.
...
```xml
<PackageReference Include="Microsoft.WindowsAppSDK.RunSupport" Version="0.1.10" PrivateAssets="all" />
```
