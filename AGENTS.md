...
(plugins\winapp\skills are autogenerated from docs\fragments\skills)
...
- `plugins/winapp/skills/winapp-*/SKILL.md` — plugin skills (shared by GitHub Copilot and Claude Code)
